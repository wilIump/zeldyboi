...
function create() {
    ...
    //spawn_enemy();
    orange_guy = game.add.group()
    
    orange_guy.create(orange_boi_spawn1.x * 16, orange_boi_spawn1.y * 16, 'enemy', 0);
    orange_guy.create(orange_boi_spawn2.x * 16, orange_boi_spawn2.y * 16, 'enemy', 0);
    orange_guy.create(orange_boi_spawn3.x * 16, orange_boi_spawn3.y * 16, 'enemy', 0);
    orange_guy.create(orange_boi_spawn4.x * 16, orange_boi_spawn4.y * 16, 'enemy', 0);
    ...
    game.physics.enable(orange_guy, Phaser.Physics.ARCADE);
...
function update() {
    ...
    game.physics.arcade.overlap(sword, orange_guy, sword_hide);
